class Searcher extends React.Component {
  ...
  handleSubmit(event, getDataFromForm) {
    ...
    var alts = []; //soumission uniquement si produit pas vide

    if (this.state.useralt.length > 0) {
      //Provider
      getDataFromForm("Recherche en cours..."); //api requête : 

      var contexte = this;
      var request = "https://fr.openfoodfacts.org/categorie/" + this.state.useralt + ".json";
      fetch(request).then(response => response.json()).then(data => data.products.map(function (produit) {
        var alt = {
          id: "",
          nom: "",
          glucides: "",
      ...
      }).catch(error => getDataFromForm("Aliment non trouvé dans BDD")); //gestion erreur : cf https://www.pierre-giraud.com/javascript-apprendre-coder-cours/api-fetch/		
    } else {
      //message à afficher
  ...
  render() {
    return (
      ...
      React.createElement("form", {
        onSubmit: event => this.handleSubmit(event, getDataFromForm)
      }, /*#__PURE__*/React.createElement("label", null, /*#__PURE__*/React.createElement("i", {
        className: "bi bi-search"
      }), " (indiquez votre aliment au pluriel) :\xA0", /*#__PURE__*/React.createElement("input", {
        type: "text",
        placeholder: "ex: pommes de terre...",
        value: this.state.useralt,
        onChange: this.handleChange
      })), /*#__PURE__*/React.createElement("input", {
        type: "submit",
        value: "Rechercher"
      }), " ", /*#__PURE__*/React.createElement("span", null, " ", board.length > 0 ? " Aliments trouvés : " + board.length : null)) //-----------------------
      ) //---------------------------		
